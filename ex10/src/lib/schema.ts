...
export const schema = z.object({
    commentary: z
        .string()
        .describe(
            "If you are generating code, describe what you're about to do and the steps you want to take for generating the fragment in great detail. Alternatively, if no code needs to be generated, simply respond to the user with a response. This response without code should be a regular response, not a commentary about the response."
        ),
    template: z
        .string()
